...
class CreateInstanceWizardResultsStep extends React.Component {
  navToItem = e => {
    e.preventDefault();
...
CreateInstanceWizardResultsStep.propTypes = {
  createItem: PropTypes.object,
  navigateRequest: PropTypes.func
};

CreateInstanceWizardResultsStep.defaultProps = {
  createItem: {},
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(CreateInstanceWizardResultsStep);
